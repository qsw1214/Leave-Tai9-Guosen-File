  ...
  methods: {
    ...
    getInitUser() {
      ...
      return new Promise((resolve, reject) => {
        this.$axios
          .post(this.$api.services.pa.init)
          .then((res) => {
            resolve(res)
          })
          .catch(reject)
      ...
      return new Promise((resolve, reject) => {
        this.$axios
          ...
          .then((res) => {
            ...
            const lastForm = res.data.last_approval_form_data
            if (lastForm) {
     ...
     */
    approval({ step, success, fail, onCloseMessage }) {
      let type = 'agree'
      let tips = '同意'
      let message = '审批'
      ...
      return this.validator(() => {
        ...
        this
          ...
          .then(() => {
            this.$axios
              .post(this.$api.services.pa.approval, {
